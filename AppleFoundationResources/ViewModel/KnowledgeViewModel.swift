...
extension KnowledgeView {
    class ViewModel: ObservableObject {
        ...
        func getSampleData() {
            let sampleData = [
                Knowledge(title: "Swift Programming Language", details: "Basic syntax and features", url: "https://developer.apple.com/swift/", isSaved: true, image: "https://developer.apple.com/swift/images/swift-og.png", category: "foundation"),
                ...
                Knowledge(title: "Model-View-Controller (MVC)", details: "Design pattern for architecture", url: "https://www.youtube.com/watch?v=0PnQTeNzrLI", isSaved: true, image: "https://i3.ytimg.com/vi/0PnQTeNzrLI/maxresdefault.jpg", category: "foundation"),
                ...
                Knowledge(title: "Networking", details: "Making network requests", url: "https://www.youtube.com/watch?v=ERr0GXqILgc", isSaved: true, image: "https://i3.ytimg.com/vi/ERr0GXqILgc/maxresdefault.jpg", category: "foundation"),
                ...
                Knowledge(title: "Persistence", details: "Data storage options", url: "https://www.youtube.com/watch?v=1QOLiELlpGk", isSaved: true, image: "https://i3.ytimg.com/vi/1QOLiELlpGk/maxresdefault.jpg", category: "intermediate"),
                ...
                Knowledge(title: "Swift Package Manager", details: "Managing dependencies effectively", url: "https://www.youtube.com/watch?v=zK00FbZOxsk", isSaved: true, image: "https://i3.ytimg.com/vi/zK00FbZOxsk/maxresdefault.jpg", category: "advanced"),
                Knowledge(title: "Implementing CloudKit", details: "Store Data on Cloud", url: "https://www.youtube.com/watch?v=mXGg-iwZNUA", isSaved: true, image: "https://i3.ytimg.com/vi/mXGg-iwZNUA/maxresdefault.jpg", category: "advanced"),
        ...
        func getKnowledgeListBySaved() -> [Knowledge] {
            return knowledgeList.filter { $0.isSaved == true }
        }
